...
<div class="relative  iphoneOutline w-[40%] aspect-[1/2.067] ">
	...
	<section class="  bg-[#fcf4e4]    h-full w-full  relative -z-10 rounded-[19%]  ">
		...
		<div class="layeredWave waveStyle  absolute bottom-1 w-full rounded-b-[19%] overflow-clip">
			<svg
				id="visual"
				viewBox="0 0 960 250"
				width="480"
		...
		<div class="  flex min-h-full flex-col px-[7%] gap-[1.2rem] ">
			<div class="relative z-[100] flex w-full flex-row ">
				<Menu />
			</div>
			...
			<div class="flex flex-col px-[4%]">
				...
				<img
					class=" z-20 flex max-w-[100%] -mt-5  h-[6.5rem] w-[6.5rem]   "
